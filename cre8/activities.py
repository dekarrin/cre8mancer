...
Jobs = [
    ...
    Activity(
        5, 'Bitcoin Market Manipulation', 100,
        price=10000,
        money_cost=0,
        juice_cost=0.17,
        money_rate=27,
